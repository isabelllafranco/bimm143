...
author: "Isabella Franco A16239546"
format: pdf
editor: visual
---
...
The main function in the package is called `ggplot()`. Can I just call it
...
```{r}
p+labs(title=" Gene Expression Changes Upon Drug Expression",
x="Control", y= "Drug tested") +
scale_colour_manual( values=c("pink","purple","green") )
```
